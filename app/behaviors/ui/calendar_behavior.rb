...
# UI::CalendarBehavior
#
# @ui_component Calendar
# @ui_description Calendar component (Phlex) A date picker calendar with support for single, range, and multiple selection
# @ui_category forms
#
# @ui_anatomy Calendar - Root container for calendar (required)
#
...
# @ui_keyboard PageUp Moves focus up by page
# @ui_keyboard PageDown Moves focus down by page
#
# @ui_related date_picker
#
