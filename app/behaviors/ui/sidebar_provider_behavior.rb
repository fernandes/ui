...
# UI::SidebarProviderBehavior
#
# @ui_component Sidebar Provider
# @ui_description SidebarProvider - Phlex implementation
# @ui_category other
#
# @ui_anatomy Sidebar Provider - Root container for sidebar that manages state via Stimulus controller. (required)
#
