...
# @ui_description DatePicker Phlex component A date picker that combines a popover trigger with a calendar.
# @ui_category forms
#
# @ui_anatomy Date Picker - Root container with state management (required)
