...
#
# @ui_component Sidebar Rail
# @ui_description Rail - Phlex implementation
# @ui_category other
#
# @ui_anatomy Sidebar Rail - Invisible rail on the sidebar edge for drag-to-expand interaction. (required)
#
