...
#
# @ui_component Resizable Panel
# @ui_description ResizablePanel component (Phlex) Individual resizable panel within a panel group
# @ui_category other
#
# @ui_anatomy Resizable Panel - Resizable Panel component part (required)
