...
#
# Shared behavior for ContextMenuRadioItem component across ERB, ViewComponent, and Phlex implementations.
module UI::ContextMenuRadioItemBehavior
  # Returns HTML attributes for the radio item
  def context_menu_radio_item_html_attributes
    {
      class: context_menu_radio_item_classes,
      data: context_menu_radio_item_data_attributes,
      role: "menuitemradio",
  ...
  def context_menu_radio_item_classes
  ...
  def context_menu_radio_item_data_attributes
