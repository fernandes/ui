...
#
# @ui_component Toggle
# @ui_description Toggle - Phlex implementation
# @ui_category forms
#
# @ui_anatomy Toggle - A two-state button that can be either on or off. (required)
# @ui_anatomy Group - A container for a set of toggle items that can be toggled on or off.
#
