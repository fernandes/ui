...
#
# @ui_component Sidebar Menu Sub Button
# @ui_description MenuSubButton - Phlex implementation
# @ui_category other
#
# @ui_anatomy Sidebar Menu Sub Button - Interactive button within a sidebar submenu item. (required)
#
