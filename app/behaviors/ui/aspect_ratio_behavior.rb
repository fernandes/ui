...
#
# @ui_component Aspect Ratio
# @ui_description AspectRatio - Phlex implementation
# @ui_category layout
#
# @ui_anatomy Aspect Ratio - Displays content within a desired aspect ratio. (required)
#
