# frozen_string_literal: true
    # ItemBehavior
    #
    # Shared behavior for Item component across ERB, ViewComponent, and Phlex implementations.
    # This module provides consistent styling and HTML attribute generation for list/menu items.
