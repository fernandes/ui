...
module UI
  module DropdownMenu
    ...
    #     render UI::DropdownMenu::TriggerComponent.new { "Open" }
    #     render UI::DropdownMenu::ContentComponent.new { "Items" }
    #   end
    #
    # @example With asChild (no wrapper div)
    #   render UI::DropdownMenu::DropdownMenuComponent.new(as_child: true) do |dropdown_attrs|
