...
module UI
  module ButtonGroup
    ...
    #   render UI::ButtonGroup::ButtonGroup.new(orientation: :vertical) do
    #     render UI::Button::Button.new(variant: :outline, size: :icon) { "+" }
    #     render UI::Button::Button.new(variant: :outline, size: :icon) { "-" }
    #   end
    #
    ...
    #   render UI::ButtonGroup::ButtonGroup.new do
    #     render UI::ButtonGroup::ButtonGroup.new do
    #       render UI::Button::Button.new(variant: :outline) { "1" }
    #       render UI::Button::Button.new(variant: :outline) { "2" }
    #     end
    #     render UI::ButtonGroup::ButtonGroup.new do
    #       render UI::Button::Button.new(variant: :outline) { "Previous" }
    #       render UI::Button::Button.new(variant: :outline) { "Next" }
    #     end
    #   end
    class ButtonGroup < Phlex::HTML
