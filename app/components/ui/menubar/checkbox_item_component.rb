...
module UI
  module Menubar
    ...
    #
    # @example Basic usage
    #   render UI::Menubar::CheckboxItemComponent.new(checked: true) { "Show Toolbar" }
    class CheckboxItemComponent < ViewComponent::Base
      include UI::Menubar::MenubarCheckboxItemBehavior
