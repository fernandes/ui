...
module UI
  module Field
    ...
    #
    # @example Basic usage
    #   render UI::Field::Field.new { "Field content here" }
    #
    # @example With orientation
    #   render UI::Field::Field.new(orientation: "horizontal") { "Field content" }
    #
    # @example With validation state
    #   render UI::Field::Field.new(data_invalid: true) { "Field content" }
