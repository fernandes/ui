...
module UI
  module ResponsiveDialog
    ...
    #
    # @example Basic usage
    #   <%= render UI::ResponsiveDialog::ResponsiveDialogComponent.new do %>
    #     <!-- Content will be rendered in both Dialog and Drawer -->
    #     <form>...</form>
    #   <% end %>
    #
    # @example With custom breakpoint
    #   <%= render UI::ResponsiveDialog::ResponsiveDialogComponent.new(
    #     breakpoint: 1024,
    #     direction: "right"
    #   ) do %>
    #     <!-- Content -->
    #   <% end %>
    class ResponsiveDialogComponent < ViewComponent::Base
      ...
      def render_drawer
        render UI::Drawer::DrawerComponent.new(open: @open, direction: @direction) do
          content
        end
      end

      def render_dialog
        render UI::Dialog::DialogComponent.new(open: @open) do
          content
        end
      end
    end
