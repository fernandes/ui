...
module UI
  module Sidebar
    ...
    #
    # @example Basic usage
    #   render UI::Sidebar::MenuSkeleton.new
    #
    # @example Hide icon placeholder
    #   render UI::Sidebar::MenuSkeleton.new(show_icon: false)
    #
    # @example Multiple skeletons
    #   5.times { render UI::Sidebar::MenuSkeleton.new }
    class MenuSkeleton < Phlex::HTML
      include UI::Sidebar::MenuSkeletonBehavior
