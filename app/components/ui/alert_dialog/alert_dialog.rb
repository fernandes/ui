...
module UI
  module AlertDialog
    ...
    #     render UI::AlertDialog::Trigger.new { "Open Alert Dialog" }
    #     render UI::AlertDialog::Overlay.new
    #     render UI::AlertDialog::Content.new { "Alert dialog content here" }
    #   end
    class AlertDialog < Phlex::HTML
      include UI::AlertDialog::AlertDialogBehavior
