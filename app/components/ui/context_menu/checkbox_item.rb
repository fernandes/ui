...
module UI
  module ContextMenu
    ...
    #
    # @example Basic usage
    #   render UI::ContextMenu::CheckboxItem.new(checked: true) { "Show Status Bar" }
    class CheckboxItem < Phlex::HTML
      include UI::ContextMenu::ContextMenuCheckboxItemBehavior
