...
#
# @example Basic usage
#   render UI::TriggerComponent.new(placeholder: "Pick a date")
#
class UI::DatePickerTriggerComponent < ViewComponent::Base
  ...
  def render_label
    content_tag :span,
      ...
      class: "text-left truncate flex-1 #{"text-muted-foreground" if @selected.nil?}"
  end
