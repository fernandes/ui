# frozen_string_literal: true
    ...
    #
    # @example Basic usage
    #   render UI::DatePickerComponent.new do |dp|
    #     dp.with_trigger(placeholder: "Pick a date")
    #   end
    #
    class UI::DatePickerComponent < ViewComponent::Base
      include UI::DatePickerBehavior
      ...
      def render_label
        ...
        render UI::LabelComponent.new(for_field: @label_for, classes: "px-1") do
          @label
        end
      end

      def render_popover
        render UI::PopoverComponent.new(trigger: "click", placement: "bottom-start", offset: 4) do |popover|
          safe_join([
            trigger,
      ...
      def render_popover_content
        render UI::PopoverContentComponent.new(classes: "w-auto overflow-hidden p-0") do
