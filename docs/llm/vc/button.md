# Button Component - ViewComponent
...
- **Class**: `UI::Button::ButtonComponent`
- **File**: `app/components/ui/button/button_component.rb`
...
```ruby
<%= render UI::Button::ButtonComponent.new(variant: :destructive) { "Delete" } %>
<%= render UI::Button::ButtonComponent.new(variant: :outline) { "Cancel" } %>
<%= render UI::Button::ButtonComponent.new(variant: :ghost) { "Skip" } %>
```

### With Size

```ruby
<%= render UI::Button::ButtonComponent.new(size: :sm) { "Small" } %>
<%= render UI::Button::ButtonComponent.new(size: :lg) { "Large" } %>
```

### Disabled State

```ruby
<%= render UI::Button::ButtonComponent.new(disabled: true) { "Disabled" } %>
```

### Custom Classes

```ruby
<%= render UI::Button::ButtonComponent.new(classes: "w-full") { "Full Width" } %>
```

### Submit Button

```ruby
<%= render UI::Button::ButtonComponent.new(type: "submit") { "Submit Form" } %>
```

### With Additional Attributes

```ruby
<%= render UI::Button::ButtonComponent.new(attributes: { id: "my-button", "data-action": "click->handler#submit" }) do %>
  Submit
<% end %>
```
...
```ruby
<%= render UI::Button::ButtonComponent.new(type: "submit", variant: :default) { "Save Changes" } %>
```
...
```ruby
<%= render UI::Button::ButtonComponent.new(variant: :destructive) { "Delete Account" } %>
```
...
<%= render UI::AlertDialog::TriggerComponent.new do %>
  <%= render UI::Button::ButtonComponent.new { "Open Dialog" } %>
<% end %>
```
...
```ruby
<%= render UI::Button::ButtonComponent.new(attributes: { "data-action": "click->modal#open" }) do %>
  Open Modal
<% end %>
```
...
```ruby
<%= render UI::Button::Button.new { "Text" } %>
# ERROR: This is the Phlex component, not ViewComponent
```

### ✅ Correct: Use ButtonComponent
...
```ruby
<%= render UI::ButtonComponent.new { "Text" } %>
# ERROR: Component is inside UI::Button module
```
